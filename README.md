...
* `SSH_KEY_FILE`: the path to local private ssh key

### Decryption

Uses PGP keys. You should provide your public key to the data provider and they should encrypt before moving to their sftp pickup point. Configure your user's pgp appropriately.
